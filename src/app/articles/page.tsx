...
import { fetchPublishedStories } from "../lib/stories-data";

export default async function Page() {
  const articles: Article[] = await fetchPublishedStories();

  // Ya vienen filtrados y ordenados por el fetch que hicimos,
  ...
  return (
    <div className="w-full flex justify-center bg-slate-50">
      ...
      ========================== */}
        {featured && (
          <section className="relative w-full h-[500px] rounded-2xl overflow-hidden shadow-2xl mb-16 group">
            <Image
            ...
            <div
              ...
              className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-8 md:p-12"
            >
              <div className="max-w-3xl">
                <span
                  style={styles.tagDestacado}
                  className="bg-amber-500 text-black text-xs font-bold px-3 py-1 rounded-full uppercase mb-4 inline-block"
                >
                  Destacado
                </span>
                <h1
                ...
                <p
                  ...
                  className="text-gray-200 text-lg mb-6 line-clamp-2 max-w-2xl font-light"
                >
                  {featured.contenido}
                </p>

                <div
                  style={styles.autorFlexContainer}
                  className="flex items-center gap-4 mb-6"
                >
                  <div
                    style={styles.avatarWrapper}
                    className="relative w-10 h-10 rounded-full overflow-hidden border-2 border-amber-500"
                  >
                    <Image
                  ...
                  <div
                    style={styles.textoAutorContainer}
                    className="text-sm text-white"
                  >
                    <p style={styles.nombreAutor} className="font-semibold">
                      {featured.full_name}
                    </p>
                    <p style={styles.fechaAutor} className="opacity-70">
                ...
                <Link
                  ...
                  className="boton-historia-hover"
                >
                  Leer Historia
                </Link>
              </div>
      ...
      ========================== */}
        <h2
          ...
          className="text-3xl font-serif font-bold text-slate-800 mb-8 border-b border-slate-200 pb-4"
        >
