...
import { updateProduct, StateUpdatingProduct } from "@/app/lib/products-actions";
...
export default function Form({ categories, product }: { categories: Category[], product: Product }) {
  const updateProductWithId = updateProduct.bind(null, product.id);
  const initialState: StateUpdatingProduct = { message: null, errors: {} };
  ...
  return (
    <form className="create-form" onSubmit={handleSubmit}>
      <div className="form-group">
        ...
        <input id="name" type="text" name="nombre" defaultValue={product.name}/>
      ...
      <div className="form-group">
        ...
        <input id="price" type="number" name="precio" defaultValue={product.price} />
